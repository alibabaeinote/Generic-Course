...
## ۱. تصمیم بنیادی: مخاطب کجاست؟

این تنها تصمیمی است که **کل استک را عوض می‌کند** و باید قبل از خط اول کد بسته شود.
...
| دیتابیس | **Postgres** + **Drizzle ORM** + migration فایل‌محور | ظرفیت و پرداخت به تراکنش و قید یکتا نیاز دارند؛ Drizzle سبک و type-safe است. |
